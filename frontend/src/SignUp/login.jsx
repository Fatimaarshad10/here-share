...
function Login() {
    ...
    const handleSubmit = (event) => {
        ...
        fetch('http://localhost:3000/user/login', {
            ...
            credentials: 'include'
        }).then(response => response.json()).then(data => { // Update Redux store with session information
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="email" class="form-control" id="form-floating-2" placeholder="email"
                                            value={email}
                                            onChange={
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" id="form-floating-3" placeholder="password"
                                            value={password}
                                            onChange={
